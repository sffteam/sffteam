...
<div class="col-md-1">
<input class="form-check-input" type="checkbox" value="false" id="ST-<?=$p['code']?>" name="ST-<?=$p['code']?>" <?php if($p['stock']=="true"){echo " checked ";}?> onblur="change('stock',this.checked,this.id)" onchange="changeQT('stock',this.checked,this.id)">
